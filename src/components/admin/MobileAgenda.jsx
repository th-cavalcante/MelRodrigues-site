...
import { STATUS_OPTIONS, toISODate, bookingServiceLabel, sessionHistoryLabel } from '../../lib/agendaConstants';
            ...
            >
              <div className="admin-mobile-today-info">
                ...
                {sessionHistoryLabel(b.patients) && (
                  <span className="admin-agenda-booking-history">{sessionHistoryLabel(b.patients)}</span>
                )}
